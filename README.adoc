...
On Tuesday 30/8/22, TAs will gather in room 3A12-14. You can distribute over all exercise rooms and in case you need help either find them physically or send them a request for help via Discord.
